                        ...
                        Expanded(child: InkWell(
                          onTap: () {
                            if (question2Controller.text=="") {
                              ...
                              questionIndex = questionIndex + 1;
                              question3Controller.text=loanAutoFillData[0]["branch"].toString();
                             // getBranchList();
                              setState(() {
            ...
            TextFieldStringWidget(
              ...
              onNextTap: () {
                if (question4Controller.text == "") {
                  ...
                  questionIndex = questionIndex + 1;
                  question5Controller.text=loanAutoFillData[0]["borrower_name"];
                  setState(() {
                    ...
                    Container(
                      child: Column(
                        children: [
                          ...
                          selectIndex == "-1" ?
                          Container() : selectIndex == "Others" ? Column(
                            children: [
                              SizedBox(height: 8.0),
                              Container(
                                margin: EdgeInsets.only(right: 12),
...
// ) :
 ...
 storedData() async {
  ...
  getLoanDetails() async {
    ...
    var responseJSON = json.decode(response.body);
    isLoading=false;
    loanAutoFillData=responseJSON["data"];
    questionIndex = questionIndex + 1;
    question2Controller.text=loanAutoFillData[0]["partner"];
    setState(() {});
  }
}
