...
class Date1Widget extends StatelessWidget
{
  ...
  Date1Widget({required this.questionName,required this.questionMessage,required this.onNextTap,required this.onPreviousTap,required this.onCalenderTap,required this.startDate});
  @override
