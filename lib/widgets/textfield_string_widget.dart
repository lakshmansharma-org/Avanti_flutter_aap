...
class TextFieldEnabledWidget extends StatelessWidget
{
  final String questionName;
  final String questionMessage;
  var controller;
  ...
  Function onPreviousTap;
  final bool enabled;
  TextFieldEnabledWidget({required this.questionName,this.controller,required this.questionMessage,required this.onNextTap,required this.onPreviousTap,required this.enabled});
  @override
  Widget build(BuildContext context) {
    return Container(
      //height: 110,
